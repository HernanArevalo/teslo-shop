...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <nav
        className={clsx(
          'fixed p-5 right-0 top-0 max-w-screen-sm sm:w-[500px] h-screen bg-white z-20 shadow-2xl transform transition-transform duration-300 will-change-transform',
          {
